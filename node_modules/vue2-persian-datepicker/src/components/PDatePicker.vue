<template xmlns:v-bind="http://www.w3.org/1999/xhtml">
    <div class="pdatepicker" v-bind:class="{ 'inline' : inlineMode, wrapperClass }">
        <input :id="id"
               ...
               class="inputClass form-element-margin-btm"
               :class="{'select-error' : !isValid}">
        <span v-show="!isValid" class="error-font">{{ errMessage }}</span>
...
export default {
  name : 'PDatePicker',
  props : {'placeholder' : { default : '', String},
                'headerBackgroundColor' :{ default : '#716ACA' },
                'headerColor' : { default : 'white'},
                'dialogColor' : { default : 'black' },
                'dialogBackgroundColor' : { default : '#FFFFFF'},
                ...
                'isValid' : {default : true , Boolean},
                'errMessage' : {default : '', String }
  },
  data () {
    return {
        isDialogOpen : false,
