                                                        ...
                                                        <div class="medium-1">
                                                            ...
                                                            <div class="dropdown-pane dropdown-pane-sm " data-close-on-click="true"  data-hover="true" data-hover-pane="true"  data-position="bottom" data-alignment="right" id="pbpActionDropdown{{ $pbp->id }}" data-dropdown data-auto-focus="true">
                                                                <ul class="my-menu small-font text-right">
                                                                    <li><a data-open="preloaderModal"  onclick="PBPUpdateDialogOpen('{{ url('/budget/credit_distribution/capital_assets/provincial/proposal/getPlans') }}' , '{{ url('/budget/credit_distribution/capital_assets/provincial/proposal/getPlanRemainingAmount') }}' , '{{ $pbp->creditDistributionPlan->cdpCoId }}' , '{{ $pbp->pbpCdpId }}' , '{{ $pbp->pbpSubject }}' , '{{ $pbp->pbpCode }}' , '{{ \Modules\Admin\Entities\AmountUnit::convertDispAmountWithoutSplliter($pbp->pbpAmount) }}' , '{{ $pbp->id }}' , '{{ $pbp->pbpDescription }}')"><i class="fi-pencil size-16"></i>  ویرایش</a></li>
