<!--Modal Insert Start-->
<div style="z-index: 9999;" class="tiny reveal" id="SS_ModalInsert" data-reveal data-animation-in="slide-in-down fast bounce">
...
<!--Modal Insert Start Cost-->
<div style="z-index: 9999;" class="tiny reveal" id="SSC_ModalInsert" data-reveal data-animation-in="slide-in-down fast bounce">
    <div id="add-product" class="modal-margin small-font  padding-lr">
        {!! Form::open(array('v-on:submit' => 'createProduct', 'id' => 'registerTSForm' , 'url' => '/budget/admin/sub_seasons/register' , 'class' => 'form' , 'data-abide novalidate')) !!}
        {!! csrf_field() !!}
        <div class="grid-x" id="existErrorInRegForm" style="display: none">
            <div class="medium-12 columns padding-lr">
                <div class="alert callout">
