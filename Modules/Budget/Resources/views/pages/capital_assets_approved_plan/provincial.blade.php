<div class="tabs-panel is-active table-mrg-btm" id="provincial">
        ...
        <div class="columns">
            ...
            <div class="table-contain" id="plansTable">
                <div class="grid-x">
                        ...
                        <div class="medium-2 table-contain-border cell-vertical-center"></div>
                        <div class="medium-2 table-contain-border cell-vertical-center"></div>
                        <div class="medium-1 table-contain-border cell-vertical-center"></div>
                        <div class="medium-1 table-contain-border cell-vertical-center"></div>
                        ...
                        <div class="medium-3 table-contain-border cell-vertical-center">
                            <div class="grid-x">
                                ...
                                <div class="medium-1 cell-vertical-center">
                                    <a class="dropdown small sm-btn-align display-off"  type="button" data-toggle="planActionDropdown"><img width="15px" height="15px"  src="{{ asset('pic/menu.svg') }}"></a>
