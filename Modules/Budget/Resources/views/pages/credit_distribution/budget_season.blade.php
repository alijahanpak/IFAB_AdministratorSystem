<div class="tabs-panel table-mrg-btm dynamic-height-level1" id="budget_season_tab">
    ...
    @if(count($cdPlan_rows) > 0)
        ...
        <div class="columns">
            ...
            <!--Header End-->
            <div class="table-contain dynamic-height-level2" id="planBudgetSeasonsTable">
                <?php $rowColor = 0; ?>
                        ...
                        <div class="medium-10">
                            @foreach($rows as $row)
                                ...
                                <div class="grid-x {{ $rowColor % 2 == 1 ? 'tableRowColor' : '' }} selectAbleRow">
                                    ...
                                    <div class="medium-2 table-contain-border  cell-vertical-center">{{ $row->creditDistributionRow->cdSubject }}</div>
                                    ...
                                    <div class="medium-4 table-contain-border cell-vertical-center">
                                        <div class="grid-x">
                                            ...
                                            <div class="medium-1 cell-vertical-center">
                                                <a class="dropdown small sm-btn-align display-off"  type="button" data-toggle="planActionDropdown_budgetSeason{{ $row->cdpCdtId . $row->cdpCdrId }}"><img width="15px" height="15px"  src="{{ asset('pic/menu.svg') }}"></a>
                                                <div class="dropdown-pane dropdown-pane-sm " data-close-on-click="true"  data-hover="true" data-hover-pane="true"  data-position="bottom" data-alignment="right" id="planActionDropdown_budgetSeason{{ $row->cdpCdtId . $row->cdpCdrId }}" data-dropdown data-auto-focus="true">
                                ...
                                <div id="countyPlanAmount_bs{{ $row->cdpCdtId . $row->cdpCdrId }}" class="grid-x display-off {{ $rowColor % 2 == 1 ? 'tableRowColor' : '' }} accordionRow">
