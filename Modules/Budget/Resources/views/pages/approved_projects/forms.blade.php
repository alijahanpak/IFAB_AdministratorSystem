    ...
    <div  slot="body">
        ...
        <div style="margin-top: 20px;" class="grid-x">
            ...
            <div  class="medium-9 columns padding-lr">
                <label>
                    <input class="form-element-margin-btm" type="text" name="location" v-model="approvedProjectsInput.apLocation" v-validate="'required|numeric'" :class="{'input': true, 'error-border': errors.has('location')}">
                </label>
