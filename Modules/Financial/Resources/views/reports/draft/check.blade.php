...
<html class="no-js" lang="en" dir="rtl">
    ...
    <body style="font-size: 16px;"  class="BZar">
        <div  style="{{'width:' . ($checkFormat->cfHeight * 10) . 'mm;height:' . ($checkFormat->cfWidth * 10).'mm;'}}" class="page">
            ...
            @if($check['cPdId'] != null)
                <p class="check-element-print" style="{{'margin-top:' . (($checkFormat->cfForTop * 10) - $baseMargin) . 'mm;margin-right:' . ($checkFormat->cfForRight * 10) . 'mm;width:' . ($checkFormat->cfForWidth * 10) .'mm;'}}">{{ $check['percentageDecrease']['pdSubject'] . ' - ' . $check['draft']['dFor'] }}</p>
                <p class="check-element-print" style="{{'margin-top:' . (($checkFormat->cfPayToTop * 10) - $baseMargin) . 'mm;margin-right:' . ($checkFormat->cfPayToRight * 10) . 'mm;width:' . ($checkFormat->cfPayToWidth * 10) .'mm;'}}">{{ $check['percentageDecrease']['pdPayTo'] }}</p>
            @elseif($check['cDpId'] != null)
                <p class="check-element-print" style="{{'margin-top:' . (($checkFormat->cfForTop * 10) - $baseMargin) . 'mm;margin-right:' . ($checkFormat->cfForRight * 10) . 'mm;width:' . ($checkFormat->cfForWidth * 10) .'mm;'}}">{{$check['deposit']['depositPercentage']['dpSubject'] . ' - ' . $check['draft']['dFor'] }}</p>
                <p class="check-element-print" style="{{'margin-top:' . (($checkFormat->cfPayToTop * 10) - $baseMargin) . 'mm;margin-right:' . ($checkFormat->cfPayToRight * 10) . 'mm;width:' . ($checkFormat->cfPayToWidth * 10) .'mm;'}}">{{$check['deposit']['depositPercentage']['dpPayTo'] }}</p>
            @else
                <p class="check-element-print" style="{{'margin-top:' . (($checkFormat->cfForTop * 10) - $baseMargin) . 'mm;margin-right:' . ($checkFormat->cfForRight * 10) . 'mm;width:' . ($checkFormat->cfForWidth * 10) .'mm;'}}">{{ $check['draft']['dFor'] }}</p>
