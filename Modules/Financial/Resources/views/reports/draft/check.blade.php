...
<html class="no-js" lang="en" dir="rtl">
    ...
    <body style="font-size: 16px;"  class="BZar">
        <div  style="{{'width:' . ($checkFormat->cfHeight * 10) . 'mm;height:' . ($checkFormat->cfWidth * 10).'mm;'}}" class="page">
            ...
            <p class="check-element-print text-left size-21" style="{{'margin-top:' . (($checkFormat->cfAmountTop * 10) - $baseMargin) . 'mm;margin-right:' . ($checkFormat->cfAmountRight * 10) . 'mm;width:' . ($checkFormat->cfAmountWidth * 10) .'mm;'}}">{{$check['cAmount']}}</p>
