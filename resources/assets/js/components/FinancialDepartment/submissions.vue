                            ...
                            <div class="tabs-panel table-mrg-btm" id="commodityTab" xmlns:v-on="http://www.w3.org/1999/xhtml">
                                <div style="margin-top: 25px" class="grid-x tbl_body_style">
                                    ...
                                    <div v-show="requestTypeSend == 'BUY_SERVICES'" class="large-12 medium-12 small-12">
                                        <div class="grid-x">
                                            <div class="large-12 medium-12 small-12">
                                                <p style="margin-bottom: 5px;" class="btn-red"><span><i style="margin-left:8px;margin-top:2px;" class="fas fa-exclamation-circle btn-red size-21"></i></span>کارشناس محترم، لطفا هنگام محاسبه مبلغ برآورد، کسورات قانونی سهم کارفارما (دولت) شامل: مالیات بر ارزش افزوده و بیمه سهم کارفرما و... را در نظر بگیرید.</p>
                                            </div>
                                        </div>
                                        <div class="grid-x">
